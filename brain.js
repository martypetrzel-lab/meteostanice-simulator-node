...
export function decide(state) {
  ...
  state.brain = {
    ...
    nightBudget: nb.ok ? {
      ...
      // ✅ FIX pro UI: přidej baterii a floor i na top-level nightBudget
      batteryWh: Math.round(n(nb?.battery?.batteryWh, 0) * 10) / 10,
      batteryWhAt5: Math.round(n(nb?.battery?.batteryWhAt5, 0) * 10) / 10,
